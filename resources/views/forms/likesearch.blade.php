               ...
               <div class="panel-heading">
                <p  id="a" style="font-size:25px; font-weight:bold; color:green;">Edit Item</p>
                      ...
                      <div class="panel-body">
                          ...
                          <form action="/likeafter_search/{{$user->user_id}}" method="GET">
                            {{ csrf_field() }}
                            <br><br>
                            <div class="text-center" id="search">
                               <label for="PurchaseOrderNo" class=" control-label"><i style="color:black;">Edit the detail of Purchase Order No :</i></label>
                            <br> <br> <!--input type="text" name="PurchaseOrderNo" id="PurchaseOrderNo"-->
                        <select name="PurchaseOrderNo" id="PurchaseOrderNo" class="browser-default" style="width:500px; height:30px;" required>
                            <option value="">SELECT</option>
                            @foreach($PO as $P)
                            <option value="{{$P->PurchaseOrderNo}}">{{$P->PurchaseOrderNo}}</option>;
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           ...
                           <input type="submit" class="btn btn-success" id="Search" value="Enter">
                           </div>
                        </form>
                      </div>
            </div>
