...
<div class="container-fluid">
      <div class="col-md-12">
         ...
         <div class="panel panel-default panel-responsive">
 	             ...
 	             <div class="panel-heading">
 		                 <p id="a" style="font-size:25px; font-weight:bold; color:green;">Group User</p>
    </div>
                      <div class="panel-body">
                      
  <table class="table table-responsive table-striped table-bordered col-lg-12">
  		  <h3><i> In this page there are {{ $users->count() }} users. </i>
         </h3>
  		  <thead>
  		  	<th>id</th>
          <th>Name</th>
  ...
  @foreach($users as $user)
      ...
      <td>
        <form  action="/update1/{{$user->id}}/{{$all->user_id}}" method="POST">
         {{ csrf_field() }}
          <input type="text" class="form-control" id="Group" name="Group" value="{{$user->Group}}">
